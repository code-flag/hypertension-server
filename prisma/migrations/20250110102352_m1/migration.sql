...
CREATE TABLE "Payment" (
    ...
    "authorizationLevel" INTEGER NOT NULL DEFAULT 0,
    "authorizedBy" JSONB[],
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Screening" (
    ...
    "screeningRewardStatus" BOOLEAN NOT NULL DEFAULT false,
    "referrerRewardStatus" BOOLEAN NOT NULL DEFAULT false,
    "elevatedRewardStatus" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_ppmvNumber_fkey" FOREIGN KEY ("ppmvNumber") REFERENCES "PpmvAgent"("phoneNumber") ON DELETE RESTRICT ON UPDATE CASCADE;
